...
type AppConfig struct {
	...
	KafkaTopicTraffic string `env:"KAFKA_TOPIC_TRAFFIC" env-default:"telemetry.traffic"`
	KafkaTopicDensity string `env:"KAFKA_TOPIC_DENSITY" env-default:"telemetry.density"`
	KafkaTopicSpeed   string `env:"KAFKA_TOPIC_SPEED" env-default:"telemetry.speed"`
